...
class ArcFace:
    ...
    APP_ID: bytes = b"Bbvyu5GeUE8eaBhyLsNcp49HW6tuPx3sqWog8i9S41Q7"
    SDK_KEY: bytes = b"EvvwdWPFj7XjL1siCQiSD2qGjG6kmH5uZpAkggSw4kMF"
    ...
    def _activate() -> None:
        ...
        ret = arcface_sdk.online_activation(b"Bbvyu5GeUE8eaBhyLsNcp49HW6tuPx3sqWog8i9S41Q7", b"EvvwdWPFj7XjL1siCQiSD2qGjG6kmH5uZpAkggSw4kMF")
    ...
    def detect_faces(self, image: np.ndarray) -> List[FaceInfo]:
        ...
        传入image
        """
        assert image.flags.c_contiguous, "图片所占的内存必需连续"
    ...
    def set_liveness_threshold(self, threshold_rgb: float, threshold_ir: float) -> None:
        """
        设置活体检测的阈值
        threshold_rgb: RGB 活体置信度
        threshold_ir: IR 活体置信度
        """
